...
export default function SpecialistsSearchFilters({
  ...
  return (
    <div className="bg-white rounded-xl text-gray-600 shadow-md p-4">
      <div className="flex flex-col xl:flex-row gap-3">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white border border-gray-300 rounded-lg px-3 py-2 pr-7 focus:ring-2 focus:ring-orange-500 focus:border-transparent min-w-[180px] text-sm"
            >
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none bg-white border border-gray-300 rounded-lg px-3 py-2 pr-7 focus:ring-2 focus:ring-orange-500 focus:border-transparent min-w-[140px] text-sm"
            >
        ...
        <button
          ...
          className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg transition-colors flex items-center justify-center whitespace-nowrap text-sm"
        >
