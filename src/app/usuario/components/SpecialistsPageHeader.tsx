    ...
    <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg shadow-lg p-4 text-white">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between">
        <div className="mb-3 md:mb-0">
          <h1 className="text-xl font-bold mb-1">{t('specialists_header')}</h1>
          <p className="text-white/80 text-sm">{t('specialists_header_sub')}</p>
        </div>
        <div className="text-right">
          <div className="text-2xl font-bold">{totalSpecialists}</div>
          <div className="text-white/80 text-xs">{t('specialists_available')}</div>
        </div>
      </div>
    </div>
  );
