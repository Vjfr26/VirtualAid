...
export default function SpecialistCard({
  ...
  return (
    <div className="group p-6 hover:bg-orange-50 transition-colors">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between">
        <div className="flex items-center space-x-4 flex-1 min-w-0">
          <div className="relative">
            {medico.avatar ? (
              ...
              <div className="w-16 h-16 bg-gradient-to-br from-orange-100 to-orange-200 rounded-full flex items-center justify-center border-2 border-orange-200 group-hover:border-orange-400 transition-colors">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center space-x-2 mb-2">
              ...
              <span className="text-orange-600 font-medium">{medico.especialidad}</span>
            </div>
        ...
        <div className="flex flex-col space-y-2 mt-4 sm:mt-0 sm:ml-4 w-full sm:w-auto">
          <button 
            ...
            className="w-full sm:w-auto bg-orange-600 hover:bg-orange-700 text-white px-6 py-2 rounded-lg font-medium transition-all duration-200 transform hover:scale-105 flex items-center justify-center space-x-2"
          >
          ...
          <button 
            ...
            className="w-full sm:w-auto border border-gray-300 hover:border-orange-300 text-gray-700 hover:text-orange-700 px-6 py-2 rounded-lg font-medium transition-colors flex items-center justify-center space-x-2"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
